...
# setting repo
wget https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/epel-release-6-8.noarch.rpm
wget https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/remi-release-6.rpm
rpm -Uvh epel-release-6-8.noarch.rpm
rpm -Uvh remi-release-6.rpm

if [ "$OS" == "x86_64" ]; then
  wget https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/app/rpmforge.rpm
  rpm -Uvh rpmforge.rpm
else
  wget https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/centos/app/rpmforge.rpm
  rpm -Uvh rpmforge.rpm
fi
...
# install screenfetch
cd
wget https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/screenfetch-dev
...
# install webserver
cd
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/centos/conf/nginx.conf"
sed -i 's/www-data/nginx/g' /etc/nginx/nginx.conf
mkdir -p /home/vps/public_html
echo "<pre>Setup by Apache07</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
rm /etc/nginx/conf.d/*
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/conf/vps.conf"
...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/1194-centos.conf"
if [ "$OS" == "x86_64" ]; then
  wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/1194-centos64.conf"
fi
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/open-vpn.conf"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/badvpn-udpgw64"
fi
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/mrtg.conf" >> /etc/mrtg/mrtg.cfg
...
wget https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/vnstat_php_frontend-1.5.1.tar.gz
...
# install squid
yum -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/squid-centos.conf"
...
# pasang bmon
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/bmon "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/bmon64"
else
  wget -O /usr/bin/bmon "https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/conf/bmon"
fi
chmod +x /usr/bin/bmon

# block abuse
cd
wget https://raw.githubusercontent.com/Autoscriptsabahan/cen6zya/master/block-abuse.sh
...
echo "Timezone : Asia/Kuala_lumpra log-install.txt
